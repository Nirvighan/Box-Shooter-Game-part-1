...
function setup() {
    ...
    ground3 = new Ground(150, 200, 175, 20);
    box43 = new Particleblue(80, 180, 20, 20);
    box44 = new Particleblue(100, 180, 20, 20);
    box45 = new Particleblue(120, 180, 20, 20);
    box46 = new Particleblue(140, 180, 20, 20);
    box47 = new Particleblue(160, 180, 20, 20);
    box48 = new Particleblue(180, 180, 20, 20);
    box49 = new Particleblue(200, 180, 20, 20);
    box50 = new Particleblue(220, 180, 20, 20);

    box51 = new Particlegreen(90, 160, 20, 20);
    box52 = new Particlegreen(110, 160, 20, 20);
    box53 = new Particlegreen(130, 160, 20, 20);
    box54 = new Particlegreen(150, 160, 20, 20);
    box55 = new Particlegreen(170, 160, 20, 20);
    box56 = new Particlegreen(190, 160, 20, 20);
    box57 = new Particlegreen(210, 160, 20, 20);

    box58 = new Particlered(100, 140, 20, 20);
    box59 = new Particlered(120, 140, 20, 20);
    box60 = new Particlered(140, 140, 20, 20);
    box61 = new Particlered(160, 140, 20, 20);
    box62 = new Particlered(180, 140, 20, 20);
    box63 = new Particlered(200, 140, 20, 20);
